...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://xrootd-cms.infn.it//store/data/Run2018D/ZeroBias1/RAW/v1/000/324/725/00000/01BF44F6-4157-9649-BBC1-C69EABB42B98.root')
)
...
process.ecalEBunpacker = cms.EDProducer("EcalRawToDigi",
    DoRegional = cms.bool(False),
    FEDs = cms.vint32(
        601, 602, 603, 604, 605, 
        606, 607, 608, 609, 610, 
...
process.rawCaloStage2Digis = cms.EDProducer("L1TRawToDigi",
    FWId = cms.uint32(0),
    FWOverride = cms.bool(False),
    FedIds = cms.vint32(1360, 1366),
    InputLabel = cms.InputTag("rawDataCollector"),
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('102X_dataRun2_Prompt_v4'),
...
process.p = cms.Path(process.L1Reco+process.gtStage2Digis+process.ecalTriggerPrimitiveDigis+process.tuplizer)
