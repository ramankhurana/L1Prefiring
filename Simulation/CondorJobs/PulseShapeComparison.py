...
usage = "no usage message yet, "
parser = argparse.ArgumentParser(description=usage)

parser.add_argument("-inputfile", "--inputfile",  dest="inputfile",default="")
parser.add_argument("-outputfile", "--outputfile",  dest="outputfile",default="")
args = parser.parse_args()

#filespath="/afs/cern.ch/work/k/khurana/L1Prefiring/EDAnalyzer/CMSSW_10_2_1/src/L1Prefiring/PrefiringTuplizer/Tuples/"
...
ievent=0
for df in read_root(filename, 'tuplizer/prefiringTree', vars_, chunksize=50):
