...
ls -ltr 
python PulseShapeComparison.py  --inputfile /eos/cms/store/user/khurana/ECALPrivate/Tuples/Histo_L1Prefiring.root --outputfile /eos/cms/store/user/khurana/ECALPrivate/CSVFiles/Histo_L1Prefiring.csv
