...
ls -ltr 
python PulseShapeComparison.py  --inputfile /eos/cms/store/user/khurana/ECALPrivate/Tuples/Histo_L1Prefiring_p8ns.root --outputfile /eos/cms/store/user/khurana/ECALPrivate/CSVFiles/Histo_L1Prefiring_p8ns.csv
